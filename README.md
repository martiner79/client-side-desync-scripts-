Este script refiere a la vulnerabilidad "Client Side Desync via HTTP Request Smuggling". El mismo fue realizado para ponerlo en práctica en el siguiente laboratorio:
